...
# 💻OPTIONAL: RUN DOCKER🎉 (เอ่อคือ Docker รันได้นะคะเจอหน้าเว็บ สามารถ create ได้เข้า database แล้ว แต่มันไม่โชว์ข้อมูลค่ะ แต่โปรเจคจริงๆโชว์ได้นะคะ)
...
link JAR file: https://drive.google.com/drive/folders/1sO70zivLf6LGlVCjDUiQX4Zx_NWy6vwY?usp=drive_link
